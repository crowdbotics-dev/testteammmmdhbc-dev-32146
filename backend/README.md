...
## Project Structure
    ...
    ├── testteammmmdhbc_dev_32146  # Django project configurations
...
1. Clone this repo and `cd testteammmmdhbc_dev_32146`
...
2. Clone this repo and `cd testteammmmdhbc_dev_32146`
